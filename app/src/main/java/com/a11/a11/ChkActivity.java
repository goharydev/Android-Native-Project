...
public class ChkActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		if ((FirebaseAuth.getInstance().getCurrentUser() != null)) {
			...
			startActivity(login);
			SketchwareUtil.showMessage(getApplicationContext(), "Logged in Successfuly !");
		}
		else {
			SketchwareUtil.showMessage(getApplicationContext(), "Entered User Data Error\ntry again");
			finish();
		}
	}
